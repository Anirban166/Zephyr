...
test.bin: sjf.o fcfs.o easy.o sharedUtils.o batchScheduler.o
	$(C) $(CFLAGS) -o test.bin sjf.o fcfs.o easy.o sharedUtils.o batchScheduler.o
...
clean:	
	rm test.bin sjf.o fcfs.o easy.o sharedUtils.o batchScheduler.o